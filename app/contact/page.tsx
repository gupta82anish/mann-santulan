        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 mb-12">
            <div className="space-y-6">
              ...
              {/* <div>
                <h2 className="text-2xl font-light text-gray-800 mb-4">Session Fee</h2>
                <p className="text-gray-700 leading-relaxed">
                  My fee per session: <span className="font-medium">INR 1000</span>
                </p>
              </div> */}
              ...
              <div>
                <h2 className="text-2xl font-light text-gray-800 mb-4">Important Note</h2>
                <p className="text-gray-700 leading-relaxed">
